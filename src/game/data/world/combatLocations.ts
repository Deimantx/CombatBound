...
export const combatLocationDefinitions = deepFreeze<CombatLocationDefinition[]>([
  {
    ...
    enemyPool: [
      ...
      { enemyId: 'enemy.alpha-wolf', weight: 3, role: 'elite', maxCopiesPerGroup: 1, minHunterRank: 5 },
    ],
  ...
  },
  {
    ...
    enemyPool: [
      ...
      { enemyId: 'enemy.bandit-captain', weight: 3, role: 'elite', maxCopiesPerGroup: 1, minHunterRank: 8 },
    ],
