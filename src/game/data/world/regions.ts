...
export const regionDefinitions = deepFreeze<RegionDefinition[]>([
  { id: 'region.northwood', continentId: 'continent.greenvale', name: 'Northwood', description: 'A forested northern region where predators and raiders compete for old trails.', areaIds: ['area.deep-woods', 'area.old-road'], availability: 'available', recommendedCombatLevel: [1, 15], presentation: { accent: 'green', iconKey: 'map' } },
