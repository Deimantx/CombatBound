...
export const combatStatReferences: CombatStatReference[] = [
  ...
  stat("baseCritChance", "Base Critical Chance", "offense", "percent", "Base chance for an eligible hit to Critically Strike."),
  ...
  stat("armour", "Armour", "defense", "number", "Mitigates Physical hit damage based on the size of the hit, capped at 90%."),
  stat("additionalPhysicalDamageReduction", "Additional Physical Damage Reduction", "defense", "percent", "Flat percentage reduction applied to eligible Physical damage."),
  stat("evasionRating", "Evasion Rating", "defense", "number", "Evasion Rating opposes Accuracy for incoming Attacks."),
  stat("attackBlockChance", "Attack Block Chance", "defense", "percent", "Chance to fully prevent an eligible Attack hit."),
  stat("spellBlockChance", "Spell Block Chance", "defense", "percent", "Chance to fully prevent an eligible Spell hit."),
  stat("spellSuppressionChance", "Spell Suppression Chance", "defense", "percent", "Chance to prevent part of eligible Spell hit damage."),
  stat("suppressedSpellDamagePrevented", "Suppressed Spell Damage Prevented", "defense", "percent", "Damage prevented when Spell Suppression succeeds."),
