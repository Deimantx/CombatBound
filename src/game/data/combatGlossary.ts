...
export const combatStatReferences: CombatStatReference[] = [
  ...
  stat({ id: 'healthRegen', statKey: 'healthRegen', label: 'Health Regen', category: 'defense', format: 'number', shortDescription: 'Health restored automatically each second during active combat.', fullDescription: 'Health restored automatically each second during active combat. Cannot heal above Max Health.' }),
