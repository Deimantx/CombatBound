...
const authoredEnemyDefinitions: EnemyDefinition[] = [
  ...
  // under the current global no-Elite assignment rule. [TUNING]
  {
    ...
    loot: [{ itemId: 'item.bandit-scrap', chance: 0.8, minQuantity: 1, maxQuantity: 2 }, { itemId: 'item.coin-pouch', chance: 0.45, minQuantity: 1, maxQuantity: 1 }], resistances: {}, icon: 'shield', accent: 'blue',
  },
  {
    ...
    loot: [{ itemId: 'item.bandit-scrap', chance: 0.8, minQuantity: 1, maxQuantity: 2 }, { itemId: 'item.coin-pouch', chance: 0.6, minQuantity: 1, maxQuantity: 2 }], resistances: {}, icon: 'target', accent: 'gold',
  },
  {
  ...
  },
  {
    ...
    enemyTier: 'normal', traits: [], combatAbilityIds: [],
    loot: [{ itemId: 'item.bandit-scrap', chance: 1, minQuantity: 2, maxQuantity: 4 }, { itemId: 'item.coin-pouch', chance: 0.8, minQuantity: 1, maxQuantity: 2 }], resistances: {}, icon: 'shield', accent: 'gold',
  },
]
