...
const authoredEnemyDefinitions: EnemyDefinition[] = [
  {
    ...
    enemyTier: 'normal', traits: [], combatAbilityIds: [], actions: [],
  ...
  },
  {
    ...
    enemyTier: 'normal', traits: [], combatAbilityIds: ['enemy-ability.charged-shot'], actions: [],
  ...
  },
  {
    ...
    enemyTier: 'elite', traits: [], combatAbilityIds: [], actions: [],
