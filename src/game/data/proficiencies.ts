...
const baseDefinitions: ProficiencyDefinition[] = [
  ...
  { id: 'fire-magic', name: 'Fire Magic', category: 'magic', description: 'Aggressive Fire spells, direct destruction, and Burn pressure.', icon: 'spark', maxLevel: MAX_PROFICIENCY_LEVEL, perkIds: authoredPerkIds('fire-magic') },
  ...
  { id: 'air-magic', name: 'Air Magic', category: 'magic', description: 'Lightning, speed, chain damage, interruption, and mobility.', icon: 'wind', maxLevel: MAX_PROFICIENCY_LEVEL, perkIds: authoredPerkIds('air-magic') },
  ...
  { id: 'light-magic', name: 'Light Magic', category: 'magic', description: 'Radiance, healing, protection, cleansing, and graceful Mana support.', icon: 'sun', maxLevel: MAX_PROFICIENCY_LEVEL, perkIds: authoredPerkIds('light-magic') },
  ...
  { id: 'shield', name: 'Shield', category: 'defense', description: 'Defensive offhand mastery focused on Block Chance, Block Power, counterattacks, and warding.', icon: 'shield', maxLevel: MAX_PROFICIENCY_LEVEL, perkIds: authoredPerkIds('shield') },
]
