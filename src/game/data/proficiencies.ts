...
const baseDefinitions: ProficiencyDefinition[] = [
  ...
  { id: 'shield', name: 'Shield', category: 'defense', description: 'Defensive offhand mastery focused on Attack Block, counterattacks, and warding.', icon: 'shield', maxLevel: MAX_PROFICIENCY_LEVEL, perkIds: authoredPerkIds('shield') },
]
