...
const baseDefinitions: ProficiencyDefinition[] = [
  ...
  { id: 'magic-arts', name: 'Magic Arts', category: 'magic', description: 'Arcane combat disciplines developed through the Magic Arts you cast.', icon: 'sparkles', maxLevel: MAX_PROFICIENCY_LEVEL, perkIds: [] },
  { id: 'light-armor', name: 'Light Armor', category: 'defense', description: 'Arcane mobility armor focused on Mana, efficiency, Evasion, and magical protection.', icon: 'wind', maxLevel: MAX_PROFICIENCY_LEVEL, perkIds: authoredPerkIds('light-armor') },
