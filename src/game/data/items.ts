...
const authoredItemDefinitions: ItemDefinition[] = [
  ...
  { id: 'item.training-shield', name: 'Training Shield', category: 'armor', rarity: 'common', description: 'A simple offhand shield for learning to guard.', icon: 'shield', inventoryMode: 'instance', requiredMasteryLevel: 1, equipmentSlotKind: 'offhand', defensiveProficiencyId: 'shield', stats: { armour: 5, blockChance: .05, blockEffect: .25 } },
  ...
  { id: 'item.vanguard-helm', name: 'Vanguard Helm', category: 'armor', rarity: 'rare', description: 'A heavy helm built for veteran front-line work.', icon: 'helm', inventoryMode: 'instance', requiredMasteryLevel: 10, equipmentSlotKind: 'head', defensiveProficiencyId: 'heavy-armor', stats: { armour: 9, maxLife: 15, lifeRegenFlat: .2 } },
  ...
  { id: 'item.vanguard-plate', name: 'Vanguard Plate', category: 'armor', rarity: 'rare', description: 'A heavy torso-and-leg armor package for veteran hunters.', icon: 'shield', inventoryMode: 'instance', requiredMasteryLevel: 10, equipmentSlotKind: 'armor', defensiveProficiencyId: 'heavy-armor', stats: { maxLife: 70, armour: 24, lifeRegenFlat: .5 } },
  ...
  { id: 'item.vanguard-gauntlets', name: 'Vanguard Gauntlets', category: 'armor', rarity: 'rare', description: 'Heavy gauntlets that reinforce a guarded posture.', icon: 'hand', inventoryMode: 'instance', requiredMasteryLevel: 10, equipmentSlotKind: 'gloves', defensiveProficiencyId: 'heavy-armor', stats: { armour: 9, maxLife: 10, blockChance: .03 } },
  ...
  { id: 'item.warden-cape', name: 'Warden Cape', category: 'accessory', rarity: 'uncommon', description: 'A warded cape that turns aside physical blows.', icon: 'cape', inventoryMode: 'instance', requiredMasteryLevel: 5, equipmentSlotKind: 'cape', stats: { armour: 8 } },
  { id: 'item.vanguard-cape', name: 'Vanguard Cape', category: 'accessory', rarity: 'rare', description: 'A veteran cape layered with protective insignia.', icon: 'cape', inventoryMode: 'instance', requiredMasteryLevel: 10, equipmentSlotKind: 'cape', stats: { armour: 7, maxLife: 20 } },
  ...
  { id: 'item.arcane-necklace', name: 'Arcane Necklace', category: 'accessory', rarity: 'rare', description: 'A necklace that carries a deep reserve of arcane energy.', icon: 'necklace', inventoryMode: 'instance', requiredMasteryLevel: 10, equipmentSlotKind: 'necklace', stats: { maxMana: 22, manaRegenFlat: .6 } },
  ...
  { id: 'item.duelist-ring', name: 'Duelist Ring', category: 'accessory', rarity: 'uncommon', description: 'A ring favored by hunters who value timing and footwork.', icon: 'ring', inventoryMode: 'instance', requiredMasteryLevel: 5, equipmentSlotKind: 'ring', stats: { accuracyRating: 5, evasionRating: 2, criticalStrikeChance: .02 } },
  { id: 'item.ring-of-precision', name: 'Ring of Precision', category: 'accessory', rarity: 'rare', description: 'A finely balanced ring for exacting strikes.', icon: 'ring', inventoryMode: 'instance', requiredMasteryLevel: 10, equipmentSlotKind: 'ring', stats: { accuracyRating: 8, criticalStrikeChance: .03, criticalStrikeMultiplier: .1 } },
