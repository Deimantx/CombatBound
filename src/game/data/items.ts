...
const authoredItemDefinitions: ItemDefinition[] = [
  ...
  { id: 'item.training-sword', name: 'Training Sword', category: 'weapon', rarity: 'common', description: 'A dependable starter weapon.', icon: 'sword', requiredMasteryLevel: 1, equipmentSlotKind: 'weapon', weaponProficiencyId: 'one-handed-sword', stats: { baseDamageMin: 28, baseDamageMax: 28, accuracyRating: 5, baseAttackTime: 2.4 } },
  { id: 'item.hunter-sword', name: 'Hunter Sword', category: 'weapon', rarity: 'uncommon', description: 'A sharper sword recovered from repeated hunts.', icon: 'sword', requiredMasteryLevel: 5, equipmentSlotKind: 'weapon', weaponProficiencyId: 'one-handed-sword', stats: { baseDamageMin: 34, baseDamageMax: 34, accuracyRating: 8, baseAttackTime: 2.2 } },
  { id: 'item.vanguard-sword', name: 'Vanguard Sword', category: 'weapon', rarity: 'rare', description: 'A balanced veteran blade built around speed and precision.', icon: 'sword', requiredMasteryLevel: 10, equipmentSlotKind: 'weapon', weaponProficiencyId: 'one-handed-sword', stats: { baseDamageMin: 40, baseDamageMax: 40, accuracyRating: 14, baseAttackTime: 2.05, baseCritChance: .02 } },
