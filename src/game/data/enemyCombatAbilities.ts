...
const definitions: EnemyCombatAbilityDefinition[] = [
  ...
  ability("enemy-ability.life-drain", "Life Drain", "A Chaos hit that heals for 50% of actual HP damage.", "chaos", "player", 15, [damage("magic", "chaos", 2.5), { type: "damage-based-heal", fraction: .5 }], { allowedEnemyTiers: general }),
