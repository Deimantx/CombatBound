...
const mace = makeTree("iron-mace", "item.iron-mace", [
  { id: "crusher", name: "Crusher", styleLabel: "Crushed", description: "Improves armor pressure from repeated impacts.", icon: "mace", nodes: [
    ...
    { id: "total-crush", name: "Total Crush", description: "Heavy Impact gains damage and armor penetration.", costs: cost(["item.iron-bar", 8], ["item.crusher-pincer", 1], ["item.black-stone", 1]), effects: [mechanic("weapon-mechanic.mace-impact", "heavyDamageMore", 0.15), mechanic("weapon-mechanic.mace-impact", "heavyArmorPenetrationFlat", 0.10)] },
  ] },
...
const warhammer = makeTree("iron-warhammer", "item.iron-warhammer", [
  { id: "shatter", name: "Shatter", styleLabel: "Armor", description: "Deepens Shatter penetration and Charged Impact.", icon: "warhammer", nodes: [
    ...
    { id: "pulverize", name: "Pulverize", description: "Charged Impact gains penetration and starts Shatter at 2 stacks.", costs: cost(["item.iron-bar", 8], ["item.crusher-pincer", 1], ["item.black-stone", 1]), effects: [mechanic("weapon-mechanic.warhammer-charged-impact", "armorPenetrationFlat", 0.15), mechanic("weapon-mechanic.warhammer-charged-impact", "nextStacks", 1)] },
  ] },
...
const spear = makeTree("iron-spear", "item.iron-spear", [
  ...
  { id: "piercer", name: "Piercer", styleLabel: "Penetration", description: "Turns Mark into reliable armor penetration.", icon: "target", nodes: [
    ...
    { id: "armour-gap", name: "Armour Gap", description: "Counter-Thrust gains +10 percentage points armor penetration.", costs: cost(["item.iron-bar", 6], ["item.ironback-core", 1]), effects: [mechanic("weapon-mechanic.spear-counter-thrust", "armorPenetrationFlat", 0.10)] },
