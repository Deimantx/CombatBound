...
const profile: WeaponTreeProfile = {
  ...
  crossNodes: [
    ...
    { name: 'Crimson Precision', links: [[1, 6], [2, 6]], effects: [{ type: 'statModifier', stat: 'baseCritChance', operation: 'flat', valuePerRank: .04 }, conditional(.1, { type: 'targetHasEffect', effectId: 'effect.bleed' })] },
  ...
  apexEffects: [damage(.15), interval(-.08), { type: 'statModifier', stat: 'baseCritChance', operation: 'flat', valuePerRank: .08 }, { type: 'statModifier', stat: 'criticalStrikeMultiplier', operation: 'flat', valuePerRank: .2 }, { type: 'statModifier', stat: 'accuracyRating', operation: 'flat', valuePerRank: 8 }],
}
