...
const profile: WeaponTreeProfile = {
  ...
  branches: [
    ...
    { name: 'Mobility / Evasion', kind: 'dodge', names: ['Mobile Archer', 'Light Footing', 'Loose on the Move', 'Skirmish Step', 'Untouchable Archer', 'Running Shot', 'Ghost Archer'], icon: 'bow' },
  ...
  crossNodes: [
    ...
    { name: 'Mobile Marksman', links: [[3, 6], [1, 6]], effects: [{ type: 'onDodgeApplyEffect', effectId: 'effect.mobile-archer', durationSeconds: 3 }, { type: 'statModifier', stat: 'accuracy', operation: 'flat', valuePerRank: 8 }] },
  ...
  apexEffects: [damage(.2), interval(-.08), { type: 'statModifier', stat: 'critChance', operation: 'flat', valuePerRank: .08 }, { type: 'weaponSecondaryTargetDamage', fractionPerRank: .25, maxAdditionalTargets: 3 }, { type: 'statModifier', stat: 'dodgeChance', operation: 'flat', valuePerRank: .05 }],
}
