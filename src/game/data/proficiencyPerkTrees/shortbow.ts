...
const profile: WeaponTreeProfile = {
  ...
  apexEffects: [damage(.2), interval(-.08), { type: 'statModifier', stat: 'baseCritChance', operation: 'flat', valuePerRank: .08 }, { type: 'weaponSecondaryTargetDamage', fractionPerRank: .25, maxAdditionalTargets: 3 }, { type: 'statModifier', stat: 'evasionRating', operation: 'flat', valuePerRank: 10 }],
}
