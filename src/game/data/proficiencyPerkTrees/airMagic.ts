...
const profile: MagicTreeProfile = {
  ...
  apexName: 'Stormlord', apexEffects: [{ type: 'spellDamageModifier', valuePerRank: .15 }, { type: 'spellCooldownModifier', valuePerRank: -.15 }, { type: 'statModifier', stat: 'evasionRating', operation: 'flat', valuePerRank: 5 }, { type: 'appliedEffectDurationModifier', effectId: 'effect.shocked', valuePerRank: .15 }, { type: 'onSuccessfulInterruptRestoreMana', amountPerRank: 5 }],
}
