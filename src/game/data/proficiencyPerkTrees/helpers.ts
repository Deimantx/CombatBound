...
function branchEffects(kind: WeaponBranchKind, index: number, icon: string): ProficiencyPerkEffect[] {
  ...
  if (kind === 'cleave' || kind === 'multi') return variants([[damage(.02)], [damage(.02)], [damage(.03)], [damage(.05)], [damage(.06)], [damage(.08)], [damage(.1)]])
