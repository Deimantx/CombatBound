...
const profile: MagicTreeProfile = {
  proficiencyId: 'earth-magic', schoolName: 'Earth Magic', damageType: 'earth', rootName: 'Earth Magic Mastery', icon: 'mountain',
  branches: [
  ...
  crossNodes: [
    { name: 'Stonebreaker', links: [[1, 5], [4, 5]], effects: [{ type: 'spellConditionalDamageModifier', operation: 'addPercent', valuePerRank: .15, condition: { type: 'targetHasEffectAndHpBelow', effectId: 'effect.concussed', fraction: 1 } }] },
    { name: 'Fortress of Stone', links: [[2, 5], [3, 5]], effects: [{ type: 'statModifier', stat: 'armor', operation: 'flat', valuePerRank: 10 }, { type: 'barrierAmountModifier', valuePerRank: .15 }] },
    { name: 'Avalanche', links: [[0, 5], [4, 5]], effects: [{ type: 'spellConditionalDamageModifier', operation: 'addPercent', valuePerRank: .15, condition: { type: 'targetHasEffect', effectId: 'effect.concussed' } }, { type: 'appliedEffectDurationModifier', effectId: 'effect.concussed', valuePerRank: .1 }] },
  ],
  apexName: 'Master of Earth', apexEffects: [{ type: 'spellDamageModifier', valuePerRank: .2 }, { type: 'statModifier', stat: 'armor', operation: 'flat', valuePerRank: 15 }, { type: 'barrierAmountModifier', valuePerRank: .15 }, { type: 'spellArmorPenetrationModifier', mode: 'percent', valuePerRank: .1 }, { type: 'appliedEffectDurationModifier', effectId: 'effect.concussed', valuePerRank: .15 }],
}
