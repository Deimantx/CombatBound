...
const profile: WeaponTreeProfile = {
  ...
  branches: [
    ...
    { name: 'Parry / Counter', kind: 'parry', names: ['Shaft Guard', 'Deflecting Reach', 'Counter Thrust', 'Return Point', 'Guarded Reach', 'Counterfighter', 'Perfect Counterthrust'] },
  ...
  crossNodes: [
    { name: "Duelist's Reach", links: [[0, 6], [3, 6]], effects: [{ type: 'statModifier', stat: 'accuracy', operation: 'flat', valuePerRank: 8 }, { type: 'statModifier', stat: 'parryChance', operation: 'flat', valuePerRank: .03 }] },
  ...
  apexEffects: [damage(.15), { type: 'statModifier', stat: 'accuracy', operation: 'flat', valuePerRank: 12 }, { type: 'statModifier', stat: 'critChance', operation: 'flat', valuePerRank: .05 }, { type: 'statModifier', stat: 'parryChance', operation: 'flat', valuePerRank: .05 }, interval(-.05)],
}
