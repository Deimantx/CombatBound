...
const profile: MagicTreeProfile = {
  proficiencyId: 'darkness-magic', schoolName: 'Darkness Magic', damageType: 'darkness', rootName: 'Darkness Magic Mastery', icon: 'moon',
  branches: [
  ...
  crossNodes: [
    ...
    { name: 'Rotting Doom', links: [[2, 5], [4, 5]], effects: [{ type: 'spellConditionalDamageModifier', operation: 'addPercent', valuePerRank: .15, condition: { type: 'targetHasEffectAndHpBelow', effectId: 'effect.shadow-decay', fraction: .4 } }] },
