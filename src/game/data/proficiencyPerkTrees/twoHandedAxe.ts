...
const profile: WeaponTreeProfile = {
  proficiencyId: 'two-handed-axe', weaponName: 'Two-Handed Axe', rootName: 'Greataxe Mastery', icon: 'axe', apexName: 'Greataxe Master',
  branches: [
    ...
    { name: 'Armor Break', kind: 'armor', names: ['Split Iron', 'Crush Plate', 'Sunder Deep', 'Open the Shell', 'Shatter Guard', 'No Armor Left', 'Siegebreaker'] },
  ...
  crossNodes: [
    { name: 'Blood and Iron', links: [[1, 6], [2, 6]], effects: [{ type: 'weaponConditionalDamageModifier', operation: 'addPercent', valuePerRank: .12, condition: { type: 'targetHasEffect', effectId: 'effect.bleed' } }, { type: 'weaponArmorPenetrationModifier', mode: 'flat', valuePerRank: 10 }] },
  ...
  apexEffects: [damage(.2), { type: 'statModifier', stat: 'critDamage', operation: 'flat', valuePerRank: .2 }, { type: 'weaponArmorPenetrationModifier', mode: 'percent', valuePerRank: .15 }, interval(-.05)],
}
