...
import type { GameSaveV14, GameSaveV15, GameSaveV16, GameSaveV17, GameSaveV18, GameSaveV19 } from "../persistence/saveTypes";
...
export function loadProfileGameSave(profileId: ProfileId): GameSaveV19 | null {
...
export function saveProfileGameSave(profileId: ProfileId, save: GameSaveV19 | GameSaveV18 | GameSaveV17 | GameSaveV16 | GameSaveV15 | GameSaveV14): boolean {
  if (typeof localStorage === "undefined") return true;
  try {
