...
import type { GameSaveV14, GameSaveV15 } from "../persistence/saveTypes";
...
export function loadProfileGameSave(profileId: ProfileId): GameSaveV15 | null {
...
export function saveProfileGameSave(profileId: ProfileId, save: GameSaveV15 | GameSaveV14): boolean {
  if (typeof localStorage === "undefined") return true;
  try {
