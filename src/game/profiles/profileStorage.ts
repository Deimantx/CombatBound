...
import type { GameSaveV9 } from "../persistence/saveTypes";
import {
  PROFILE_SLOT_COUNT,
  isDifficulty,
  isProfileId,
...
export function loadProfileGameSave(profileId: ProfileId): GameSaveV9 | null {
...
export function saveProfileGameSave(profileId: ProfileId, save: GameSaveV9): void {
