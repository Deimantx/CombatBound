...
import type { GameSaveV14, GameSaveV15, GameSaveV16 } from "../persistence/saveTypes";
...
export function loadProfileGameSave(profileId: ProfileId): GameSaveV16 | null {
...
export function saveProfileGameSave(profileId: ProfileId, save: GameSaveV16 | GameSaveV15 | GameSaveV14): boolean {
  if (typeof localStorage === "undefined") return true;
  try {
