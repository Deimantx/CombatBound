...
export const weaponMechanicSchemas: readonly WeaponMechanicSchema[] = [
  ...
  schema("weapon-mechanic.mace-impact", { requiredHits: 2, heavyDamageMore: 0.20, heavyArmorPenetrationFlat: 0.10, heavyBlockEffectMultiplier: 0.75, baseBlockEffectMultiplier: 0, barrierDamageMore: 0, heavyCritChance: 0 }),
  ...
  schema("weapon-mechanic.greatsword-perfect-swing", { maxStacks: 3 }),
  ...
  schema("weapon-mechanic.warhammer-charged-impact", { threshold: 3, damageMore: 0.30, armorPenetrationFlat: 0.20, blockEffectMultiplier: 0.50, nextStacks: 1, baseBlockEffectMultiplier: 0, barrierDamageMore: 0, barrierChargedDamageMore: 0 }),
  ...
  schema("weapon-mechanic.spear-counter-thrust", { durationSeconds: 4, timerAdvanceFraction: 0.20, damageMore: 0.10, critChanceFlat: 0.10, armorPenetrationFlat: 0, additionalMark: 0, additionalPrecisionChain: 0 }),
];
