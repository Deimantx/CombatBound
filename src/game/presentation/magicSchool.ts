...
const schools: Partial<Record<MagicProficiencyId, MagicSchoolPresentation>> = {
  "fire-magic": { id: "fire-magic", label: "Fire", fullLabel: "Fire Magic", icon: "spark", description: "Direct damage and Ignite pressure.", accent: "fire" },
...
export function getMagicSchoolPresentation(id: MagicProficiencyId) {
  return schools[id] as MagicSchoolPresentation;
}
