...
export function TopStatusBar({ onInspect }: { onInspect: () => void }) {
  ...
  return (
    <header className="topbar" data-ui-region="header" data-debug-screen="shell">
      <div className="player-identity"><div className="avatar-badge"><Shield size={19} /></div><div><strong>Vanguard</strong><span>Combat Lv {totalLevel} <i /> Power {stats.attack}</span></div></div>
