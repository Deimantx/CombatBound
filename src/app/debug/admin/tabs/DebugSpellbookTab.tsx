...
export function DebugSpellbookTab({ run, debug }: DebugTabProps) {
  ...
  const [expanded, setExpanded] = useState<Set<string>>(() => new Set([`debug.spells.${knownSchool ?? "fire-magic"}`]));
