...
export function DebugOfflineTimeTab({ run }: DebugTabProps) {
  ...
  const lease = useMemo(() => profileId ? getActiveProfileLease(profileId) : null, [profileId, metadata?.lastActiveAt, metadata?.offlineBankSeconds]);
