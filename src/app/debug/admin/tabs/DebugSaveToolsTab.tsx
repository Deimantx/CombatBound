...
export function DebugSaveToolsTab({ debug, run }: DebugTabProps) {
  ...
  const validation = parsed && isGameSaveV15(parsed) ? "VALID V15" : parsed && typeof parsed === "object" && (parsed as { version?: unknown }).version !== 15 ? "LEGACY DETECTED - IMPORT WILL MIGRATE" : "INVALID";
