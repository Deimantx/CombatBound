...
export function DebugSaveToolsTab({ debug, run }: DebugTabProps) {
  ...
  const validation = parsed && isGameSaveV17(parsed) ? "VALID V17" : parsed && typeof parsed === "object" && (parsed as { version?: unknown }).version !== 17 ? "LEGACY DETECTED - IMPORT WILL MIGRATE" : "INVALID";
