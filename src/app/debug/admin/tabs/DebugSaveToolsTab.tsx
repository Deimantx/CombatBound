...
export function DebugSaveToolsTab({ debug, run }: DebugTabProps) {
  ...
  const validation = parsed && isGameSaveV20(parsed) ? "VALID V20" : parsed && typeof parsed === "object" && (parsed as { version?: unknown }).version !== 20 ? "LEGACY DETECTED - IMPORT WILL MIGRATE" : "INVALID";
