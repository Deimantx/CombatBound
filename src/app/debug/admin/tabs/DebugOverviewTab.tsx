...
export function DebugOverviewTab({ debug, run, setTab }: DebugTabProps & { setTab: (tab: DebugTab) => void; selectedEnemy?: string }) {
  ...
  return <div className="debug-tab-content">
    ...
    <div className="debug-summary-grid">
      <DebugSummaryCard label="Hunter Rank" value={"Rank " + rankProgress.rank} detail={rankProgress.totalPoints.toLocaleString() + " points"} />
      <DebugSummaryCard label="Perk points" value={perkPoints.available} detail={perkPoints.bonus + " bonus - " + perkPoints.spent + " spent"} />
