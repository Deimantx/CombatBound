...
export function CombatScreen() {
  ...
  return <div className="screen combat-screen" data-debug-screen="combat">
    ...
    <div className="combat-main-grid">
      <HunterCombatPanel game={game} stats={stats} onSetStance={setStance} onToggleTechnique={toggleTechnique} />
      <LiveHuntPanel game={game} stats={stats} location={location} selectedEnemy={selectedEnemy} selectedDefinition={selectedDefinition} onSelectTarget={selectTarget} onCastSpell={castSpell} onUsePotion={usePotion} onStartHunt={startHunt} onStopHunt={stopHunt} />
      <SelectedEnemyPanel game={game} selectedEnemy={selectedEnemy} />
    </div>
    <HuntSessionOverview game={game} tab={overviewTab} onTabChange={setOverviewTab} />
  </div>
}
