...
export function getSpellUiState(spell: SpellDefinition, runtime: SpellRuntime | undefined, combat: CombatState, selectedAction?: EnemyActionDefinition, effectiveSpell: EffectiveSpellDefinition = spell as EffectiveSpellDefinition): SpellUiState {
  ...
  if (combat.mana < effectiveSpell.manaCost) return { enabled: false, status: `NEED ${effectiveSpell.manaCost} MANA`, tone: 'invalid' }
