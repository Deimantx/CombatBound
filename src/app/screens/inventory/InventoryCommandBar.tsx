...
export function InventoryCommandBar(props: InventoryCommandBarProps) {
  ...
  return <div className="inventory-commandbar" data-debug-kind="inventory-commandbar">
    <div className="inventory-toolbar-row"><SearchField value={props.query} onChange={props.onQueryChange} placeholder="Search names, types, rarity, proficiency, or affixes" label="Search inventory" /><div className="inventory-toolbar-actions">
