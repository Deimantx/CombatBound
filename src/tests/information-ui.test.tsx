...
describe('combat information surfaces', () => {
  it('renders the complete collapsible Hunter Combat Stats sheet', () => {
    ...
    for (const label of ['Attack Power', 'Accuracy', 'Attack Interval', 'Critical Hit Chance', 'Critical Hit Damage', 'Max Health', 'Armor', 'Evasion', 'Dodge Chance', 'Parry Chance', 'Block Chance', 'Block Power', 'Status Resistance', 'Max Stamina', 'Stamina Regeneration', 'Max Mana', 'Mana Regeneration', 'Physical Resistance', 'Fire Resistance', 'Water Resistance', 'Air Resistance', 'Earth Resistance', 'Light Resistance', 'Darkness Resistance', 'Nature Resistance', 'Mystic Resistance']) expect(screen.getAllByText(label).length).toBeGreaterThan(0)
