...
describe('combat world atlas browser', () => {
  it('drills from World to Greenvale, Northwood, Deep Woods, and Wolf Den', () => {
    ...
    expect(document.querySelector('[data-debug-kind="combat-target-preview"][data-debug-enemy-id="enemy.grey-wolf"]')).toHaveClass('location-target-card')
  ...
  it('browses the hierarchy during combat without changing the active hunt', () => {
    ...
    expect(screen.getByRole('button', { name: 'Switch to selected target' })).toBeInTheDocument()
  })
