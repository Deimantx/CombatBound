...
const items = { ...itemById, ...Object.fromEntries([
  ...
  piece('test.medium-armor', 'armor', 'medium-armor'), piece('test.heavy-gloves', 'gloves', 'heavy-armor'), piece('test.heavy-boots', 'boots', 'heavy-armor'), piece('test.shield', 'offhand', 'shield', { armour: 4, blockChance: .1, baseAttackTime: .5 }),
